# DiceMaster
![Version](https://img.shields.io/badge/Version-3.3.8-blueviolet?style=for-the-badge)
...
![My machine](https://img.shields.io/badge/Makes%20people-Smyle-cyan?style=for-the-badge)
...
## HOW TO RUN?
It's really easy: first, clone the repo, then make sure the **sshkeyboard** library is installed and, finally, run **DiceMaster.py**.
