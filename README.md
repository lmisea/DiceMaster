...
It is also my first Python project by the way.
...
It's really easy: first, clone the repository, then make sure the **_sshkeyboard_** library is installed and, finally, run [_run.py_](https://github.com/lmisea/dicemaster/blob/main/run.py).
...
A third-party Python library called **_sshkeyboard_** under the [MIT License](https://github.com/ollipal/sshkeyboard/blob/main/LICENSE) is required for running DiceMaster. **Note:** For Python 3.7 it is also required **_typing_extensions_**, that is why it is on [_requirements.txt_](https://github.com/lmisea/dicemaster/blob/main/requirements.txt).

GitHub Repository of the third-party Library: [Sshkeyboard-Repository](https://github.com/ollipal/sshkeyboard).
...
Make sure the terminal is open in the directory where the repository was clone and run [_run.py_](https://github.com/lmisea/dicemaster/blob/main/run.py) with Python 3:
